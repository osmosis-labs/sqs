...
class TestCandidateRoutes:
    ...
    @pytest.mark.parametrize("denom", conftest.valid_listed_tokens)
    ...
    def test_transmuter_tokens(self, environment_url):
        ...
        transmuter_token_data = conftest.transmuter_token_pairs[0]
    ...
    def test_astroport_tokens(self, environment_url):
        ...
        astroport_token_data = conftest.astroport_token_pair[0]
    ...
    @pytest.mark.parametrize("pair", conftest.misc_token_pairs)
...
def validate_candidate_routes(routes, token_in, token_out, expected_min_routes, expected_max_routes):
    ...
    for route in routes:
        ...
        for pool in pools:
            ...
            expected_pool_data = conftest.pool_by_id_map.get(pool_id)
