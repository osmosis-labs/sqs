...
require (
	...
	github.com/osmosis-labs/osmosis/v28 v28.0.2
...
require (
	...
	github.com/osmosis-labs/osmoutil-go v0.0.17 // indirect
...
require (
	...
	github.com/osmosis-labs/osmosis/x/ibc-hooks v0.0.18 // indirect
