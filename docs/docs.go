        ...
        "/passthrough/orderbook-ticks": {
            "get": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "Pool is not a known canonical orderbook",
                        "schema": {
                            "$ref": "#/definitions/domain.ResponseError"
                        }
                    },
