...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_osmosis-labs_sqs_pkg_api_v1beta1_pools.CalculateSpotPriceResponse"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_osmosis-labs_sqs_pkg_api_v1beta1_pools.CalculateSpotPriceResponse": {
            "type": "object",
            "properties": {
                "spot_price": {
                    "description": "spot_price is the calculated spot price of the pool.",
                    "type": "string"
                }
            }
        },
