...
type OrderbookRepositoryMock struct {
	...
	GetOrdersFunc   func(poolID uint64) ([]orderbookdomain.Order, bool)
}
...
func (m *OrderbookRepositoryMock) GetOrders(poolID uint64) ([]orderbookdomain.Order, bool) {
	if m.GetOrdersFunc != nil {
		return m.GetOrdersFunc(poolID)
	}
