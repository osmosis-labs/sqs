...
type RouterRepository interface {
	...
	GetTakerFee(ctx context.Context, denom0, denom1 string) (osmomath.Dec, bool)
	// GetAllTakerFees returns all taker fees
	GetAllTakerFees(ctx context.Context) sqsdomain.TakerFeeMap
	...
	SetTakerFee(ctx context.Context, denom0, denom1 string, takerFee osmomath.Dec)
	SetTakerFees(ctx context.Context, takerFees sqsdomain.TakerFeeMap)
}
...
func (r *routerRepo) GetAllTakerFees(ctx context.Context) sqsdomain.TakerFeeMap {
...
func (r *routerRepo) GetTakerFee(ctx context.Context, denom0 string, denom1 string) (math.LegacyDec, bool) {
...
func (r *routerRepo) SetTakerFee(ctx context.Context, denom0 string, denom1 string, takerFee math.LegacyDec) {
	// Ensure increasing lexicographic order.
	if denom1 < denom0 {
		denom0, denom1 = denom1, denom0
	}
...
func (r *routerRepo) SetTakerFees(ctx context.Context, takerFees sqsdomain.TakerFeeMap) {
	for denomPair, takerFee := range takerFees {
		r.SetTakerFee(ctx, denomPair.Denom0, denomPair.Denom1, takerFee)
	}
}
