...
func (r *routerUseCaseImpl) HandleRoutes(ctx context.Context, pools []sqsdomain.PoolI, tokenInDenom, tokenOutDenom string, maxRoutes, maxPoolsPerRoute int) (candidateRoutes sqsdomain.CandidateRoutes, err error) {
	return r.handleCandidateRoutes(ctx, pools, tokenInDenom, tokenOutDenom, maxRoutes, maxPoolsPerRoute)
}
